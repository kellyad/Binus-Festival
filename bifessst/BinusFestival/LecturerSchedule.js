...
var subView = {
                ...
                function(result){
                    if (result == 'Yes') {
                       ...
                       // reason = $('#txtReason').val(),
                        ...
                        BM.ajax({
                            url: BM.serviceUri + "BifestController/LecturerScheduleHandler/changeAllLecturerSchedule",
                            type: "POST",
    ...
    ExportToExcel : function() {
        ...
        var data = {};
            ...
            form.action = BM.serviceUri+'BifestController/LecturerScheduleHandler/getExportData';
                form.method = 'POST';
                form.target = '_blank';
                if (data) {
                    for (var key in data) {
