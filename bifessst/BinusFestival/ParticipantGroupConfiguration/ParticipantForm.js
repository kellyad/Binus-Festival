...
var popupSubView = {
    ...
    onLoaded: function(arg)
    {
        ...
        psx.init();
        $('#actionTitle2').html("ADD NEW ");}
        console.log("argument"+arg);
        
        if (BM.filter.participantID !='' ) {
        $('#actionTitle2').html("EDIT ");
                ...
                {  
                    ...
                    BM.ajax({
                        ...
                        success: function(data){
                            ...
                            $("#ddlPeriod").val(datas[0].Include_STRM);
                    ...
                    BM.ajax({
                        ...
                        success: function(data){
                            $('#ddlJurusanExclude').multiselect({allSelectedText: 'Select All',includeSelectAllOption: true,enableFiltering: true,enableCaseInsensitiveFiltering: true});
                                $('.multiselect-container').css('z-index', '2');
                    ...
                    BM.ajax({
                        ...
                        success: function(data){
                            $('#ddlSystemExclude').multiselect({allSelectedText: 'Select All',includeSelectAllOption: true,enableFiltering: true,enableCaseInsensitiveFiltering: true});
                    ...
                    BM.ajax({
                        ...
                        success: function(data){
                             $('#ddlCoursesExclude').multiselect({allSelectedText: 'Select All',includeSelectAllOption: true,enableFiltering: true,enableCaseInsensitiveFiltering: true});
                                $('.multiselect-container').css('z-index', '2');
                                $('.btn-group').click(function(event){
                                    if(!$(this).hasClass('open'))
                                    {
