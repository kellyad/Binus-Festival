...
var popupSubView = {
    ...
    onLoaded: function() {
        ...
        BM.ajax({
         ...
         BM.ajax({
            url : BM.serviceUri + "BifestController/ScheduleAttributeHandler/getAllGenerateData",
            type: "POST",
            data: JSON.stringify({
                }),
            success: function(data){
            ...
            BM.ajax({
            url: BM.serviceUri + 'BifestController/ScheduleAttributeHandler/getAllScheduleAttribute',
            type: 'post',
            data: JSON.stringify({
                                                    ...
                                                    BM.ajax({
                                                        ...
                                                        success: function(result) {
                                                            if (result[0].Status == "Success") {
                                                                ...
                                                                BM.ajax({
                                                                    url: BM.serviceUri + 'BifestController/ScheduleAttributeHandler/updateScheduleAttribute',
                                                                    type: 'POST',
                                                                    data: JSON.stringify({
                                                                        TopicID:BM.filter.TopicID,
                                                                        STRM: BM.filter.Period,
