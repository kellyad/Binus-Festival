...
var popupSubView = {
	...
	onLoaded: function(){
		...
		$('#formAddParticipantGroup').submit(function(e){
			...
			if (validation == 1)
			{
				...
				BM.ajax({
					url: BM.serviceUri+"staff/HeadPrefect_Configuration/addParticipantGroupConfiguration",
	...
	loadFilter: function(initParam){
        ...
        BM.ajax({
            url:BM.serviceUri+"staff/HeadPrefect_Configuration/getFilterParticipantGroup",
