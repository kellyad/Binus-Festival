...
var subView = {
    ...
    {   BM.popUpResult = {};
        ...
        BM.ajax({
            url : BM.serviceUri + "BifestController/ParticipantHandler/getSystemByID",
            data : JSON.stringify({
                    SystemID:arg
                }),
            type: "POST",
        ...
        BM.filter={SystemID : arg};
                        window.location = "#/event/binusfestival/ParticipantGroupConfiguration."+arg+"#ParticipantGroupForm";
                    });
        $('#btnGoToRoomConfiguration').click(function(event){
        BM.filter={SystemID : arg};
         BM.ajax({
            url : BM.serviceUri + "BifestController/ParticipantHandler/getParticipantGroupConfig",
            data : JSON.stringify({
                    SystemID:arg
                }),
            type: "POST",
            success: function(data){
                ...
                window.location = "#/event/binusfestival/ScheduleConfiguration."+arg;
                // window.open("#/event/binusfestival/konfigurasiJadwalRuangan."+arg,"_blank");
            }
        });
    ...
    ExportToExcel : function(initParam) {
        ...
        var data = {};
            ...
            form.action = BM.serviceUri+'BifestController/ParticipantHandler/getExportData';
                form.method = 'POST';
                form.target = '_blank';
                if (data) {
                    for (var key in data) {
    ...
    loadTable :function(initParam){
        var sx = this;
         BM.ajax({
            url: BM.serviceUri + "BifestController/ParticipantHandler/getParticipantGroupConfiguration",
            data: JSON.stringify({'SystemID': initParam}),
            type: "POST",
            async: false,
            dataType: "json",
            ...
            success: function(result) {
                $.each(result, function(a, e) {
                    ...
                    $('.iOption .icon-edit', c).click(function(event){
                    BM.filter={SystemID : initParam, ParticipantGroupID : e.ParticipantGroupID};
                        window.location = "#/event/binusfestival/ParticipantGroupConfiguration."+initParam+"#ParticipantGroupForm";
                    });
                    $('.iOption .icon-trash', c).click(function(event){
                        BM.ajax({
                            url: BM.serviceUri + "BifestController/ParticipantHandler/deleteParticipantGroupConfiguration",
                            data: JSON.stringify({'ParticipantGroupID': e.ParticipantGroupID}),
                            type: "POST",
                            async: false,
                            dataType: "json",
    ...
    loadDataTable : function(initParam,ParticipantGroupID,participantgroupname){
        ...
        $('#btnAddParticipantPopUp').click(function(event){
             BM.filter={SystemID : initParam, ParticipantGroupID : ParticipantGroupID, ParticipantGroupName :participantgroupname, participantID :''};
                        window.location = "#/event/binusfestival/ParticipantGroupConfiguration."+initParam+"#ParticipantForm";
        });
        BM.ajax({
            url: BM.serviceUri + "BifestController/ParticipantHandler/getAllParticipantByParticipantGroupID",
            ...
            success: function(result) {
                $.each(result, function(a, e) {
                    ...
                    $('.iOption .icon-trash', c).click(function(event){
                        BM.ajax({
                                url: BM.serviceUri + "BifestController/ParticipantHandler/deleteParticipantConfiguration",
