   ...
   loadCapacity : function(c) {
    ...
    loadInit: function() {
        ...
        // $('#labelEndDate').html(($('#TxtEndDate').val()=="")?"ALL" :new Date($('#TxtEndDate').val()).toString("dd MMMM yyyy"));
         BM.ajax({
            url : BM.serviceUri + "BifestController/AttendanceHandler/getAttendanceData",
            type: "POST",
            data: JSON.stringify({   
                         ...
                         $('#btnSubmit',c).click(function(){
                            var request =
                                ...
                                function(){
                                    ...
                                    BM.ajax({
                                        url: BM.serviceUri + 'BifestController/AttendanceHandler/validateAttendance',
                                        type: "POST",
    ...
    ExportToExcel : function() {
        var sx = this;
        var data = {};
                            data['Main'] = "AttendanceVerification";
                            ...
                            data['ValidateStatus'] = $('#ddlValidate option:selected').val();
                            data['STRM'] = $('#ddlPeriod option:selected').val();
                            data['StartDate'] = $('#TxtStartDate').val();
                            data['EndDate'] = $('#TxtEndDate').val();
                           
                var form = document.createElement("form");
            form.action = BM.serviceUri+'BifestController/AttendanceHandler/getExportData';
                form.method = 'POST';
                form.target = '_blank';
                if (data) {
                    for (var key in data) {
