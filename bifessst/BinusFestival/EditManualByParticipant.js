   ...
   loadCapacity : function(c) {
    ...
    loadInit: function() {
       ...
       $('#tableTappingAreaPopUp_Copy').after(copy);
            BM.ajax({
            url : BM.serviceUri + "BinusFestival/GetManualParticipantData",
            type: "POST",
                ...
                $('#divContent').show();
                  if(result.length>0){
                    ...
                    $('.iAction .icon-checklist',c).click(function(d){
                        d.preventDefault();
                        BM.ajax({
                            url: BM.serviceUri + 'BinusFestival/updateManualData',
                            type: "POST",
                            data: JSON.stringify({
                    ...
                    $('.iAction .icon-trash',c).click(function(d){
                        d.preventDefault();
                        BM.ajax({
                            url: BM.serviceUri + 'BinusFestival/DeleteManualData',
                            type: 'POST',
                            data: JSON.stringify({
                                    StudentBinusFestivalID:e.StudentBinusFestivalID
                                }),
    ...
    init: function() {
       ...
       // sx.loadNewInstructor();
        ...
        $('#btnAssign').click(function () {
           window.location.href=BM.baseUri + "newstaff/#/event/binusfestival/EditManualByParticipant#AssignParticipant";
        });
